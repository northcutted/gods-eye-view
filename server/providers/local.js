...
function localProviderPlugins({
  includeKeySetup = true,
  includeRealtimeDebugLog = true,
  WebSocketImpl,
  ...
  return [
    ...
    gbfsProxy(),
    adsbLolProxy(),
    aisLiveProxy({ WebSocketImpl }),
    trackBackfillProxies(),
    openAiRealtimeProxy({ sourceRoot, includeRealtimeDebugLog }),
    googlePlacesContextProxy(),
    ...(includeKeySetup ? [keySetupEndpoint({ sourceRoot })] : []),
  ];
}
